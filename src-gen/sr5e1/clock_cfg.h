 ...
 * @{
 */
#define CLOCK_CFG_UARTSEL                   CLOCK_UARTSEL_PLL0PHI
#define CLOCK_CFG_I2CSEL                    CLOCK_I2CSEL_PLL0PHI
#define CLOCK_CFG_SPISEL                    CLOCK_SPISEL_PLL0PHI
#define CLOCK_CFG_FDCANSEL                  CLOCK_FDCANSEL_XOSC
#define CLOCK_CFG_ADCSEL                    CLOCK_ADCSEL_XOSC
#define CLOCK_CFG_SDADCSEL                  CLOCK_SDADCSEL_PLL0PHI
#define CLOCK_CFG_MCOSEL                    CLOCK_MCOSEL_NOCLOCK
#define CLOCK_CFG_RTCSEL                    CLOCK_RTCSEL_NOCLOCK
...
#define CLOCK_CFG_SDADCPRE_VALUE            2U
