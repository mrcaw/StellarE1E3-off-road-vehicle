...
typedef uint8 (*seekfree_assistant_transfer_callback_function) (const uint8 *buff, uint32 *length);
typedef uint8 (*seekfree_assistant_receive_callback_function)  (uint8 *buff, uint32 *length);
